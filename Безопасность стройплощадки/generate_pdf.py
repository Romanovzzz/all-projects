"""
Генератор PDF — Безопасность на строительной площадке.
Формирует PDF с ответами на 44 вопроса к зачёту.
"""
...
OUTPUT = os.path.join(ANSWERS_DIR, "Безопасность_стройплощадки_ответы.pdf")
...
class ExamPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 4, "Безопасность на строительной площадке — ответы к зачёту", align="L")
    ...
    def footer(self):
        ...
        self.cell(0, 5,
                  "Источники: Сугак, Седов (МГСУ); Приказ 782н; ФЗ-426; СП 48.13330",
                  align="C")
    ...
    def add_title_page(self):
        ...
        self.set_font("DS", "", 9)
        sources = [
            "Методичка Сугак Е.Б., Седов Д.С. (НИУ МГСУ, 2026)",
            "Приказ Минтруда от 16.11.2020 № 782н (работа на высоте)",
            "Приказ Минтруда от 29.10.2021 № 776н (СУОТ)",
            "Постановление Правительства от 24.12.2021 № 2464",
            "ФЗ от 28.12.2013 № 426-ФЗ (спецоценка условий труда)",
